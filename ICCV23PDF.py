...
# all stuff we need
def getUrl(html):
    reg = r'(?:href|HREF)="?((?:/content/ICCV2023/papers/)?.+?\.pdf)'
...
root_url = '/content/ICCV2023/papers/'  #下载地址中相同的部分

raw_url = 'https://openaccess.thecvf.com/ICCV2023?day=all'

html = getHtml(raw_url)
url_lst = getUrl(html)

root_dir = 'E:\Desktop\ICCV23'
