...
# all stuff we need
def getUrl(html):
    reg = r'(?:href|HREF)="?((?:/content/CVPR2021/papers/)?.+?\.pdf)'
...
def getFile(url, title, save_to):
    ...
    f = open(os.path.join(save_to, title), 'wb')
...
root_url = '/content/CVPR2021/papers/'  #下载地址中相同的部分

raw_url = 'https://openaccess.thecvf.com/CVPR2021?day=all'

html = getHtml(raw_url)
url_lst = getUrl(html)

root_dir = 'E:\Desktop\CVPR21'
