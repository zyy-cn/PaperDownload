...
# all stuff we need
def getUrl(html):
    reg = r'(?:href|HREF)="?((?:/content/CVPR2024/papers/)?.+?\.pdf)'
...
root_url = '/content/CVPR2024/papers/'  #下载地址中相同的部分

raw_url = 'https://openaccess.thecvf.com/CVPR2024?day=all'

html = getHtml(raw_url)
url_lst = getUrl(html)

root_dir = 'E:\Desktop\CVPR24'
